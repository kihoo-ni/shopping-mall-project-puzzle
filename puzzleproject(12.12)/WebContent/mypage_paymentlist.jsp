				...
				<div class="myPage-right-box">
					<form  method="post">
								...
								<tbody>
									...
									<tr>
										...
										<td style="padding:0; background: #000000;">
											<a style="color: white; padding: 44px 23px;" href="deletePaymentItem.product?productNumber=${products.productNumber}&paymentnumber=${products.paymentNumber }&productId=${products.productId }">
												결제취소
											</a>
										</td>
									</tr>
						...
						<div class="btn_wrap order_form__payment-button-wrap">
							<button class="n-btn btn-sm btn-accent" style="font-size: 16px; margin-left: 10px;" type="submit" formaction="welcome.jsp">홈으로</button>
						</div>
					</form>
				</div>
			</div>
