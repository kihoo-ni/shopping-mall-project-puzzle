			...
			<div class="cart-wrapper" id="page-cart" style="width: 100%;">
				...
				<script src="//t1.daumcdn.net/mapjsapi/bundle/postcode/prod/postcode.v2.js"></script>
					...
					<div class="section order__delivery">
						...
						<div class="order-btn">
							<button type="submit" class="n-btn btn-sm btn-accent" formaction="./addProductOrderCart.product" style="margin-right: 10px; background: #0078ff; line-height: 33px; padding: 2px 13px;">
							<span id="btn-pay_amt" style="font-size: 20px;"><fmt:formatNumber value="${sum}" pattern="#,###"/></span>원 주문하기&nbsp;
							</button>
