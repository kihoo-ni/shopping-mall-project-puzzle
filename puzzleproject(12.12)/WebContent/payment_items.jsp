		...
		<div style="display: flex;">
			...
			<div class="myPage-right-box-wrapper">
				<div class="myPage-right-box">
					<form  method="post">
					<input type="hidden" name="orderNumber" value="${product.orderNumber }">
						<div class="section order_product_info">
							<h3 style="margin-bottom: 15px;" class="order__title">상품 정보</h3>
							<!--cart products-->
								...
								<tbody>
									...
									<tr>
										...
										<td style="padding:0; background: #000000;">
											<a style="color: white; padding: 44px 23px;" href="delectOrderItem.product?productNumber=${product.productNumber }&productOrderNumber=${product.orderNumber }&productId=${product.productId }">
												주문취소
											</a>
										</td>
									</tr>
									...
									<div class="cell_order_form" style="margin-top: 15px;">
										<div class="discount_contents">
											<ul>
												...
												<li class="cell_discount_detail"><strong><fmt:formatNumber pattern="#,###" value="${product.productUnitPrice*product.productNumber }" />원</strong></li>
											</ul>
											<ul>
						...
						<div class="btn_wrap order_form__payment-button-wrap">
							<button class="n-btn btn-sm btn-accent" style="font-size: 16px; background: #0078ff; padding: 2px 10px;" type="submit" formaction="addPaymentItem.product"><span id="btn-pay_amt"><%-- <fmt:formatNumber pattern="#,###" value="${product.productUnitPrice }" />원 결제하기</span> --%>결제하기</span></button>
